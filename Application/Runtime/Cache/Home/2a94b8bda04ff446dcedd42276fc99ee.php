...
<BODY>
<div class="top_div"><br /><h1 align="center" >请您先登录，谢谢</h1></div>
...
<input class="ipt" id="" type="text" placeholder="请输入验证码" name="captcha"> 
	...
	<div style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
		<p style="margin: 0px 35px 20px 45px;"><sapn style="float: left;"><a style="color: rgb(204, 204, 204);" href="#">忘记密码?</a></sapn> 
           <sapn style="float: right;"><a style="color: rgb(204, 204, 204); margin-right: 10px;" href="/git/CMS/index.php/Home/Index/register">注册</a>  
